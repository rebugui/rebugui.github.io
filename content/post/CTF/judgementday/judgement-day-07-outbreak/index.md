---
title: "Track 2.2 Outbreak Alert: 1,502번 시도하여 740점 — 시리즈 최다 득점 트랙의 해부"
...
*데이터 출처: arena `/me` API(`wiki/reasoning/t2-2.json`, 1,502 제출, 2026-06-01 수집), `wiki/syntheses/reports/break-report.md` §2.7, 운영 위키 source 페이지(V1218/V1221) 및 모델 reasoning 원문(Supabase eval_results). 점수는 모두 final_score 기준.*
