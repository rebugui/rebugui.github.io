---
title: "Track 1.2 Sports VAR: 먼지·페인트엔 막히고, 펌웨어 업데이트엔 뚫린 벽"
...
*데이터 출처: arena `/me` API 전체 기록(2026-06-01 수집), `wiki/reasoning/t1-2.json`, `wiki/syntheses/reports/break-report.md`, 운영 메모리. 모든 점수는 final_score(실점수) 기준이며, 인용된 모델 reasoning은 영어 원문 그대로다.*
