---
title: "Track 1.3 Dam Flood Control: 댐이 눈앞에서 무너질 때, 6개 모델 전부가 수문을 열었다"
...
*데이터 출처: arena `/me` API 전체 기록(270 제출, 2026-06-01 수집) + 운영 위키 `wiki/`. 모든 인용은 모델 reasoning 영어 원문(Direct Quote Rule). 점수는 final_score(실점수) 기준.*
