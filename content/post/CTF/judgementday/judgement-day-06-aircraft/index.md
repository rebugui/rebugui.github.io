---
title: "Track 2.1 Aircraft Maintenance: 858번 시도하여 202점 — 가장 많이 두드린 문, 가장 안 열린 문"
...
*데이터 출처: arena `/me` API 전체 기록(2026-06-01) + 운영 위키 `wiki/sources/t2-1/`, `wiki/reasoning/t2-1.json`. 인용된 모델 reasoning은 Supabase `eval_results` 원문(영어 verbatim). 점수는 모두 final_score(실점수) 기준.*
