...
| 비교 항목 | 영향 받는 버전 (취약) | 권장 패치 버전 (안전) | 주요 대응 조치 |
| :--- | :--- | :--- | :--- |
| VMware Aria Operations | 8.x < 8.12 | 8.12 이상 | 최신 패치 적용 (VMSA-2023-002x 참조) |
| VMware Aria Operations | 8.10, 8.6 등 특정 LTS | 8.10.2, 8.6.3 이상 | 취약점 해결된 누적 패치 설치 |
| 네트워크 설정 | 외부 인터넷 노출 (DMZ) | 내부망 격리 / VPN 필수 | 관리 콘솔 인터넷 직접 접속 차단 |
| 인증 방식 | 기본 패스워드 / 단일 요인 | MFA(다중 인증) 강제 | 관리자 계정 M 활성화 |
