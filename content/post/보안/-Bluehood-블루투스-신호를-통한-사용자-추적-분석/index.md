...
| 비교 항목 | 고정 MAC (Static MAC) | 랜덤 MAC (Random MAC) |
| :--- | :--- | :--- |
| **추적 난이도** | 낮음 (쉬움) | 높음 (어려움) |
| **식별 지속성** | 영구적 (기기마다 고유) | 일시적 (세션마다 변경) |
| **주요 취약점** | 장기간 생활 패턴 파악 가능 | 연결 시도 시 MAC 고정화 현상 |
| **대상 기기** | 저가형 IoT, 구형 폰, 설정 변경 없는 기기 | 최신 iOS/Android (설정에 따라 다름) |
| **대응 전략** | MAC 주소 랜덤화 필수 활성화 | 주기적인 갱신 확인 필요 |
