...
| 비교 항목 | 전통적인 Supply Chain 공격 | LLM 허위 보고서에 의한 DoS |
| :--- | :--- | :--- |
| **주요 공격 벡터** | 악성 코드 삽입, Dependency Confusion | 기만적인 정보 주입 (Misinformation) |
| **공격 대상** | 소비자(최종 사용자) 시스템 | 메인테이너 및 개발자 (인적 요소) |
| **검출 난이도** | 높음 (코드 분석 도구 필요) | 매우 높음 (논리적 팩트 체크 필요) |
| **증상** | 실행 시 악의적 행위, 백도어 생성 | 기능 삭제, 서비스 중단, 업데이트 지연 |
| **필요한 기술적 스킬** | 리버스 엔지니어링, 익스플로잇 작성 | 프롬프트 엔지니어링, 사회공학 |
