...
1.  **스캔**: 공격자가 대상 네트워크 스캔(Nmap 등)을 수행하여 22번 포트가 열린 장비를 식별합니다. 2.  **접속 시도**: 기본 자격 증명(Default Credentials) 시도 또는 무차별 대입 공격(Brute Force)을 통해 SSH 쉘 획득을 시도합니다. 3.  **침해**: 쉘 획득 후 장비를 제어하거나 내부 네트워크로의 탈출(Pivoting) 경로로 사용합니다.
