...
| 위협 요소 | 패치 배포 전 (0-day) | 패치 배포 후 미적용 (1-day) | 방어 관점 위험도 |
| :--- | :--- | :--- | :--- |
| **공격 난이도** | 매우 높음 (비용 많이 듦) | 낮음 (PoC 코드 공개 가능성) | 🔴 극히 위험 |
| **공격자 수** | 제한된 APT 그룹 | 일반 사이버 범죄자 포함 폭넓음 | 🔴 대규모 타겟 |
| **방어 가시성** | 탐지 어려움 | 패치 여부로 추적 가능 | 🟡 관리적 통제 가능 |
| **노출 기간** | 취약점 발견 전까지 | 패치 적용 완료 시점까지 | 🔴 조직 자율에 달림 |
