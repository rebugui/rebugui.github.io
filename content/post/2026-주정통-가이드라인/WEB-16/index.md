...
**점검 시나리오(가상):**
- 공격자가 응답 헤더에서 서버 제품과 버전 정보를 확인합니다.
- 해당 제품의 공급사 보안 공지와 설치된 패치 수준을 대조해 취약한 구성이 있는지 찾으려 할 수 있습니다.
- 헤더를 숨기는 것만으로 패치가 적용되지는 않으므로, 운영자는 서버 버전 확인과 보안 업데이트를 별도로 수행해야 합니다.
