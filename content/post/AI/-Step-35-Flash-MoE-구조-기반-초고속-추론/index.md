...
| 비교 항목 | 일반적인 Dense 70B 모델 | 일반적인 Dense 8B 모델 | Step 3.5 Flash (MoE) |
| :--- | :--- | :--- | :--- |
| **총 파라미터** | 70B | 8B | 196B |
| **활성화 파라미터** | 70B (100%) | 8B (100%) | 11B (~5.6%) |
| **생성 속도 (Peak)** | ~50 tok/s | ~120 tok/s | **350 tok/s** |
| **컨텍스트 윈도우** | 32k ~ 128k | 32k ~ 128k | **256k** |
| **SWE-bench Verified** | ~60% ~ 65% | ~30% ~ 40% | **74.4%** |
