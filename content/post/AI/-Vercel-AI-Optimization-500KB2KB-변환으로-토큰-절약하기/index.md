...
| 비교 항목 | 기존 웹 페이지 (Standard) | AI 최적화 페이지 (Optimized) | 개선 효과 | | :--- | :--- | :--- | :--- | | **평균 페이지 크기** | ~500 KB | ~2 KB | **약 250배 감소** | | **불필요 요소** | CSS, JS, SVG, Icons, Ads | 전부 제거 (Pure Text) | 잡음 제거 | | **토큰 수량 (추정)** | ~100,000+ Tokens | ~500 Tokens | 컨텍스트 효율 극대화 | | **처리 시간 (Latency)** | 네트워크 전송 + 렌더링 지연 | 즉시 전송 및 파싱 | 실시간 대화 성능 향상 | | **주요 용도** | 시각적 컨슈머 서비스 | RAG, Agent Crawling, Summarization | 용도별 특화 |
